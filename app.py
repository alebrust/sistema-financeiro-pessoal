# --- ARQUIVO: app.py (VERSÃO 70 - RECONSTRUÇÃO COMPLETA) ---
...
with tab_transacoes:
    ...
    if not transacoes:
        ...
        col_data.write("**Data**"); col_conta.write("**Conta**"); col_desc.write("**Descrição**")
        col_cat.write("**Categoria**"); col_valor.write("**Valor**"); col_acao.write("**Ação**")
        st.divider()
...
with tab_cartoes:
    ...
    with col_cartoes2:
        with st.form("add_card_form", clear_on_submit=True):
            ...
            dia_fechamento = st.number_input("Dia do Fechamento", min_value=1, max_value=31, value=20)
            dia_vencimento = st.number_input("Dia do Vencimento", min_value=1, max_value=31, value=28)
